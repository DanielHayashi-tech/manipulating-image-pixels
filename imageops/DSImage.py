"""DSImage.py: Base class implementation to manage PGM and PPM images file. This is partial implementation for Assignment 1"""
...
class MyImage:
    ...
    def __init__(self):
        ...
        self.gray_hist = np.zeros((255,), dtype=int)
